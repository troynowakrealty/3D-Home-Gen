...
outputPath = os.path.abspath('./demo_poop.png') # make it abs path for windows
...
noiseDistortion = 0.3
brightness = 0.5
bt.setMat_poop(mesh, poopRGB1, poopRGB2, noiseScale, noiseDetail, noiseDistortion, brightness)
