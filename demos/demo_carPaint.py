...
outputPath = os.path.abspath('./demo_carPaint.png') # make it abs path for windows
...
C1 = bt.colorObj(bt.derekBlue, 0.5, 1.0, 1.0, 0.0, 0.5)
C2 = bt.colorObj(bt.royalBlue, 0.5, 1.0, 1.0, 0.0, 0.0)
