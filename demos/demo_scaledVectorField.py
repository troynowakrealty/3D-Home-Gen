...
per_vector_scales = np.random.rand(P.shape[0]) # random scaling per vector
...
arrow_mesh = bt.createScaledVectorFieldMesh(mesh,P, P_vec, thickness, length, per_vector_scales)
