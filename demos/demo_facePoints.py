...
outputPath = os.path.abspath('./demo_facePoints.png') # make it abs path for windows
...
# # draw points on face
ptColor = bt.colorObj(bt.derekBlue, 0.5, 1.2, 1.0, 0.0, 0.5) 
ptSize = 0.014
emitType = 'FACE'
showMesh = True
bt.drawPoints(mesh, ptColor, ptSize, emitType, showMesh)
