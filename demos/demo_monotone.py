...
outputPath = os.path.abspath('./demo_monotone.png') # make it abs path for windows
...
meshColor = bt.colorObj(bt.derekBlue, 0.5, 1.2, 1.0, 0.0, 0.5) 
silhouetteColor = bt.colorObj(bt.derekBlue, 0.5, 1.2, 1.0 * 0.3, 0.0, 0.5) 
shadowSize = 0.4
bt.setMat_monotone(mesh, meshColor, CList, silhouetteColor, shadowSize)
