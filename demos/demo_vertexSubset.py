...
outputPath = os.path.abspath('./demo_vertexSubset.png') # make it abs path for windows
...
# # set mesh material
meshColor = bt.colorObj((1,1,1,1), 0.5, 1.0, 2.0, 0.5, 0.0)
AOStrength = 0.0
bt.setMat_singleColor(mesh, meshColor, AOStrength)

# # draw a subset of vertices
ptSize = 0.033
ptColor = bt.colorObj(bt.derekBlue, 0.5, 1.0, 1.0, 0.0, 2.0)
ptLocation = (1e10,1e10,1e10) # some random pos
templateObj = bt.drawSphere(ptSize,ptColor,ptLocation)

VIdx = [0, 50, 100, 150, 200, 250, 300] 
bt.copyToVertexSubset(mesh, templateObj, VIdx)
