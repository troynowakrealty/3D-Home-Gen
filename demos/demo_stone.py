...
outputPath = os.path.abspath('./demo_stone.png') # make it abs path for windows
...
meshColor = bt.colorObj(stoneRGBA, 0.5, 1.4, 1.0, 0.0, 1.0)
AOStrength = 1.0
distortion = 0
bt.setMat_stone(mesh, meshColor, noiseScale, distortion, AOStrength)
